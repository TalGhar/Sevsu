<div class="h-screen">
    <div class="container mx-auto">
        <div class="flex text-center justify-center flex-col space-y-2">
            ...
            <h2 class="text-3xl">«Исследование архитектуры MVC приложения и возможностей обработки <br> данных HTML-форм
            ...
            <img src="public/assets/img/me.jpg" class="w-full object-contain h-64">
        </div>
    </div>
</div>
