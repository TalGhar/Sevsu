        ...
        {histories.length ?
          ...
          (
            <form onSubmit={handleSubmit} className='flex flex-col w-full h-full p-6 shadow-md'>
              ...
              <textarea className="shadow-md rounded text-gray-700 p-4 mb-2 leading-relaxed" name="text" placeholder='Введите текст новости' onChange={(e) => { setText(e.target.value) }} />
              <button type='submit'
