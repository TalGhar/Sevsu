<body class="bg-gray-200">
    <div class="flex justify-center items-center m-5">
        <form class="w-full max-w-lg bg-white p-6 rounded-lg shadow-md" method="POST" action="/lab3/Auth/create">
            ...
            <div class="mt-6 text-center">
                <p class="font-medium text-gray-700">Уже есть аккаунт? <a href="/lab3/Auth/signin/"
