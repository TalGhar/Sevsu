<body class="bg-gray-200">
    ...
    <div class="flex justify-center items-center m-5">
        <form class="w-full max-w-lg bg-white p-6 rounded-lg shadow-md" method="POST" action="/lab3/Auth/login">
            ...
            <div class="flex justify-between items-center">
                <a href="/lab3/Auth/signup" class="text-blue-500 hover:text-blue-700">Регистрация</a>
                <button
