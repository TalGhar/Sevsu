...
void Label::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Label::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Label::isLimit)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Label::staticMetaObject = { {
    ...
    qt_meta_stringdata_Label.offsetsAndSize,
    qt_meta_data_Label,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Label_t
, QtPrivate::TypeAndForceComplete<Label, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
